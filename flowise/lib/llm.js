// The language-model shim, shared by every flow that calls a model.
//
// Included with `// @include llm`; flowise/build.js inlines it. It reads
// $insforgeUrl and $insforgeApiKey itself rather than relying on the flow to
// have defined insforgeUrl: two flows that had not were silently ignoring the
// model picker, because the lookup threw and fell back to the installed model.
